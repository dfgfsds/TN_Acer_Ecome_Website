        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="text-center mb-8">
              <h1 className="text-4xl font-black uppercase italic tracking-tighter mb-2">Initialize Profile</h1>
              <p className="text-gray-500 text-sm font-bold tracking-widest uppercase">Create your network identity</p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Designation (Full Name)</label>
              ...
              {/* Phone */}
              <div className="space-y-1">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Comlink (Phone Number)</label>
                <div className="relative">
