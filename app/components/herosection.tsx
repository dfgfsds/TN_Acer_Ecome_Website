...
const HeroSection = () => {
    return (
        <>
            ...
            <section className="relative pt-32 pb-16 md:py-32 min-h-[85vh] bg-black text-white overflow-hidden flex items-center">
                {/* Top Gradient Only */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-6">
                    ...
                    <div className="text-center md:text-left order-2 md:order-1">
                        ...
                        <p className="mt-6 text-gray-400 text-base md:text-xl max-w-lg mx-auto md:mx-0 leading-relaxed">
                            Experience high-performance Acer laptops at TN Computers — built for speed, gaming, and productivity.
                        </p>
