...
export const putCartitemApi = async (query: any, payload: any) => {
    return axios.put(
...
export const getDeliveryDetailsApi = async (vendorId: string) => {
    return axios.get(`${ApiUrls.vendorPaymentDeliveryDetails}${vendorId}/`);
};
